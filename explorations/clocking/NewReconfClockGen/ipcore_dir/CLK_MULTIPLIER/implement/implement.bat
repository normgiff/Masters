...
xst -ifn xst.scr
move CLK_MULTIPLIER_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK_MULTIPLIER_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK_MULTIPLIER_exdes.ucf CLK_MULTIPLIER_exdes

echo 'Running map'
map -timing -pr b CLK_MULTIPLIER_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm CLK_MULTIPLIER_exdes -w routed.ncd routed.v
cd ..
